...
ADD CONSTRAINT FK_EmergencyContact_Person
FOREIGN KEY (PersonSSN)
REFERENCES Person(SSN)
ON DELETE CASCADE;

ALTER TABLE ClientNeeds
ADD CONSTRAINT FK_ClientNeeds_Client
FOREIGN KEY (ClientSSN)
...
FOREIGN KEY (DonorSSN)
REFERENCES Donor(SSN)
ON DELETE CASCADE;

ALTER TABLE CheckDonation
ADD CONSTRAINT FK_CheckDonation_Donation
FOREIGN KEY (DonorSSN, DonoDate)
REFERENCES Donation (DonorSSN, DonoDate)
ON DELETE CASCADE;

ALTER TABLE CardDonation
ADD CONSTRAINT FK_CardDonation_Donation
FOREIGN KEY (DonorSSN, DonoDate)
REFERENCES Donation (DonorSSN, DonoDate)
ON DELETE CASCADE;

ALTER TABLE Insures
ADD CONSTRAINT FK_Insures_Client
FOREIGN KEY (ClientSSN)
REFERENCES Client(SSN)
ON DELETE CASCADE;

ALTER TABLE Insures
ADD CONSTRAINT FK_Insures_Policy
FOREIGN KEY (PolicyID)
REFERENCES InsurancePolicy(PolicyID)
ON DELETE CASCADE;

ALTER TABLE Cares
ADD CONSTRAINT FK_Cares_Client
FOREIGN KEY (ClientSSN)
REFERENCES Client(SSN)
ON DELETE CASCADE;

ALTER TABLE Cares
ADD CONSTRAINT FK_Cares_Team
FOREIGN KEY (TeamName)
REFERENCES Team(TeamName)
ON DELETE CASCADE;

ALTER TABLE Serves
ADD CONSTRAINT FK_Serves_Volunteer
FOREIGN KEY (VolunteerSSN)
REFERENCES Volunteer(SSN)
ON DELETE CASCADE;

ALTER TABLE Serves
ADD CONSTRAINT FK_Serves_Team
FOREIGN KEY (TeamName)
REFERENCES Team(TeamName)
ON DELETE CASCADE;

ALTER TABLE Reports
ADD CONSTRAINT FK_Reports_Employee
FOREIGN KEY (EmployeeSSN)
REFERENCES Employee(SSN)
ON DELETE CASCADE;

ALTER TABLE Reports
ADD CONSTRAINT FK_Reports_Team
FOREIGN KEY (TeamName)
REFERENCES Team(TeamName)
ON DELETE CASCADE;
